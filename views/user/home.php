...
<head>
   <!-- <base href="http://localhost/FileRouge/FileRouge/Home"> -->
    <meta charset="UTF-8">
...
<div class="home d-flex" style="height:100vh;">
    ...
    <div class="home-pic">
        <img class="img" src="http://localhost/FileRouge/FileRouge/views/images/backgro.svg" alt="">
        <img class="img1" src="http://localhost/FileRouge/FileRouge/views/images/ho.png" alt="">
        <img class="img2" src="http://localhost/FileRouge/FileRouge/views/images/hom.png" alt="">
