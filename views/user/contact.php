                        ...
                        <div class="other">
                            ...
                            <div class="form">
                                ...
                                <form action="http://localhost/FileRouge/FileRouge/Contact/save" method="post">
                                    <div class="flex-rev">
                                        <input type="email" placeholder="Email" name="nom"> 
                                    ...
                                    <div class="flex-rev"> 
                                        <input placeholder="Saiser Votre Message" name="message" >
                                    </div>
                                    <button class="btn btn-primary" style="background-color:#ddd6cc; border:none;">Submit</button>
                               </form>
                         </div>
                 </div>
