            ...
            <div class="ville">
                ...
                <select name="ville" id="select" placeholder="Select Author" onChange="trieparville()">
                     ...
                     foreach($restaurants as $restaurant):?>
                        <option value="<?php echo $restaurant['ville'];?>"><?php echo $restaurant['ville'];?></option>";
...
<?php 
        ...
        <div class="card" style="width: 20rem; height: auto;" name="card">
            <img id="img-top" class="card-img-top" style="height:15rem;" src="http://localhost/FileRouge/FileRouge/views/images/<?php echo $plat['image'] ;?>" alt="Card image cap">
            <div class="card-body">
