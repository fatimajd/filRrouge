...
<div class="container-fluid row ">
          ...
          foreach($plats as $plat):?>
                        <tr>
                          ...
                          <td><img src="http://localhost/FileRouge/FileRouge/views/images/<?php echo $plat['image'] ;?>" alt="" height="100px" width="100px">
                          <?php echo $plat['nom'] ;?></td>
                          <td><?php echo $plat['prix'] ;?></td>
                          <form action="http://localhost/FileRouge/FileRouge/Detail/update/<?=$plat['idl']?>" method="post">
                          <td><input type="number" min="1" name="qtt"  class="inputdetail mb-4" value="<?php echo $plat['quantite'] ;?>"></td>
                  ...
                  <a href="http://localhost/FileRouge/FileRouge/Detail/delete/<?=$plat['idl']?>">
                    ...
                    <button class="btn btn-primary mb-5" style="background-color:#F6AE2D;border:none;font-family:'Otomanopee One'; margin-top:3rem;">
                Mise a jour la quantite</button>
                          </form>
          </div>
      <div class="top-sidee col-lg-3">
            <div class="total">
                <h4>Total-Prix <?php echo $prix?></h4>
                <h4>livraison 10DH</h4>
                <h4>Total <?php echo $total?></h4>
                <?php 
                $i=0;
          foreach($plats as $plat):?>
                <form action="http://localhost/FileRouge/FileRouge/Commande/save" method="post">
                
        
                <input type="hidden" name="<?php echo "id".$i;?>" value="<?php echo $plat['id'] ;?>">
                <input type="hidden" name="<?php echo "quantite".$i;?>" value="<?php echo $plat['quantite'] ;?>">
                <input type="hidden" value="<?php echo $prix?>" name="prixtotal">
